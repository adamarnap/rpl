...
<!-- LOGO DI TAMPILAN FRONNT END-->
      <div class="col-1 col-sm-1 offset-sm-0 ">
        ...
        <ul class="navbar-nav navbar-right"> &nbsp;
                    ...
                    <?php echo $this->session->userdata('namaKonsumen') ?>
                    <?php endif; ?>
                    </span> &nbsp; &nbsp;
                    <a href="<?php echo site_url('Member/menu_member'); ?>" class="btn btn-outline-light">Menu User</a>
                    &nbsp; &nbsp; 
                    <a href="<?php echo site_url('Member/keluar'); ?>" class="btn btn-outline-light">Logout</a>
      </nav>
